...
export const InputField = ({setPasteLink}:{setPasteLink : any})=>{
    ...
    <div className="relative">
        ...
        <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-[#0000CD] hover:bg-[#0000CD] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2" onClick={()=>{
            setLoading(false);
            setPasteLink(true);
